...
export function buildSpecFromAnswers(answers: Answer[]): string {
  ...
  sections.push({
    ...
    content: constraintAnswers.length > 0 
  ...
  sections.push({
    ...
    content: nonGoalAnswers.length > 0
  ...
  sections.push({
    title: "7. Data Model",
    content: dataModelAnswers.length > 0
  ...
  sections.push({
    title: "8. Interfaces",
    content: interfaceAnswers.length > 0
      ? "### User Flow\n\n" + interfaceAnswers[0] + (interfaceAnswers[1] ? "\n\n### APIs & Services\n\n" + interfaceAnswers[1] : "")
...
This spec was generated by SpecifyThat - a conversational spec generator.
...
This spec was generated based on a structured interview. Review each section and adjust as needed before implementation.
